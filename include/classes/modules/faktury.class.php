...
for($i = $Biezaca; $i < $BiezacaEnd; $i++){
    ...
    <tr>
        ...
        <?php
            ...
            echo "<th class='ikona' colspan='2'><input type='submit' value='drukuj zaznaczone' class='form-button' /></th>";
            echo "<th>&nbsp;</th>";
            echo "<th>&nbsp;</th>";
        ?>
    </tr>
...
<?php
        ...
        function WyswietlAJAX($Akcja){
            if($Akcja == "get-action-list"){
                $Akcje = array();
                $Akcje[] = array('title' => "Drukuj", "akcja_href" => "drukuj_fakture.php?", "_blank" => true);
