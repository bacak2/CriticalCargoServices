...
class KlienciPotwierdzenia extends KlienciRaporty {
	...
	function __construct(&$Baza, $Uzytkownik, $Parametr, $Sciezka) {
        ...
        function GetEmailTresc($Hash){
            ...
            $tresc_maila .= "<a href='http://orderplus.critical-cs.com/raports/potwierdzenie.php?check=$Hash'>Otwórz potwierdzenie</a><br /><br />\n";
        ...
        function AkcjaDrukuj($ID){
            ...
            if($Potwierdzenie){
                ...
                include(SCIEZKA_SZABLONOW."druki/potwierdzenie_klient.tpl.php");
            }
        }
}
?>
