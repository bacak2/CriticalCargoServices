...
class KlienciRaporty extends ModulBazowy {
	...
	function PobierzListeElementow($Filtry = array()) {
        ...
        function GetEmailTresc($Hash){
            ...
            $tresc_maila .= "<a href='http://orderplus.critical-cs.com/raports/raport.php?check=$Hash'>Otwórz raport</a><br /><br />\n";
        ...
        function AkcjaDrukuj($ID){
            ...
            if($Raport){
                ...
                include(SCIEZKA_SZABLONOW."druki/raport_klient.tpl.php");
            }
        }
