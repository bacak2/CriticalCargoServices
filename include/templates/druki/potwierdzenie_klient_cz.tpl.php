<div style="width:800px; margin: 0 auto 0 auto; text-align: left;">
	...
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%;">
		<tr>
			...
			<td style="width: 60%; font-weight: bold; font-size: 13px; text-align: right; font-style: italic;"><br /><br /><div class='inline' style='width: 100px;'>Vytvořeno:</div> <div class='data inline'><?php echo date("Y-m-d H:i:s", strtotime(($Potwierdzenie['potwierdzenie_date']))); ?></div></td>
		</tr>
	</table>
	<br /><br />
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%;">
		<tr>
			<td style="width: 60%; font-size: 16px; "><strong>Potvrzení objednávky pro:<br /><span style="font-size: 12px;"></span></strong></td>
			<td style="width: 40%; font-weight: bold; font-size: 17px;"><?php echo $Client; ?></td>
		</tr>
		<tr>
			<td style="font-size: 13px; font-weight: bold;" colspan="2">
				<br />
				Rádi bychom Vás informovali, že jsme přijali Vaši objednávku pro organizaci dopravy<br />
	...
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%; border-collapse: collapse;">
		<tr>
			...
			<th class="small bordered raport_klient">Objednávka č.</th>
			<th class="small bordered raport_klient">Vozidlo SPZ</th>
			<th class="small bordered raport_klient">Místo nakládky</th>
			<th class="small bordered raport_klient">Místo vykládky</th>
			<th class="small bordered raport_klient">Datum nakládky</th>
			<th class="small bordered raport_klient">Datum vykládky</th>
			<th class="small bordered raport_klient">Typ zásilky</th>
			<th class="small bordered raport_klient">Typ vozidla</th>
			<th class="small bordered raport_klient">Cena</th>
		</tr>
		<?php
			$Lp = 1;
