...
<table style="margin: 27px 0 5px 0" width="100%" cellpadding="5" cellspacing="0">
   ...
   <tr>
        <td colspan="2">
            <table cellpadding="3" cellspacing="0" style="border: 0; width: 100%;">
                <tr>
                    <td style="border-top: 1px solid #000; vertical-align: top; font-weight: bold;"><?php echo $Lang['NUMER_ZLECENIA']; ?><br /></td>
   ...
   <tr>
      ...
      <td width="50%" valign="top">
          <b><?php echo $Lang['BL_NO']; ?>:</b>
          <?php echo $SOI['bl_no']; ?>
      </td>
   </tr>
   <tr>
      <td colspan="2" valign="top">
          <b><?php echo $Lang['STATEK']; ?>:</b>
          <?php echo $SOI['vessel']." / ".$SOI['voyage_no']; ?>
      </td>
   </tr>
   <tr>
      <td colspan="2" valign="top">
...
$Pozycje = mysql_query("SELECT * FROM orderplus_sea_orders_faktury_pozycje WHERE id_faktury = '$ID' ORDER BY lp"); 
