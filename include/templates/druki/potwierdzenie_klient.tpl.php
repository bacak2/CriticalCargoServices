<div style="width:800px; margin: 0 auto 0 auto; text-align: left;">
	...
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%;">
		<tr>
			...
			<td style="width: 60%; font-weight: bold; font-size: 13px; text-align: right; font-style: italic;"><br /><br /><div class='inline' style='width: 100px;'>Date & Time:</div> <div class='data inline'><?php echo str_replace(" ", " / ", date("d.m.Y H:i", strtotime($Potwierdzenie['potwierdzenie_date']))).' h'; ?></div></td>
		</tr>
	</table>
	<br /><br />
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%;">
		<tr>
			<td style="width: 60%; font-size: 16px; "><strong>Forwarding order confirmation for<br /><span style="font-size: 12px;">Potwierdzenie przyjęcia zlecenia spedycyjnego  dla firmy</span></strong></td>
	...
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%; border-collapse: collapse;">
		<tr>
			...
			<th class="small bordered raport_klient">Rate</th>
		</tr>
		<?php
			$Lp = 1;
