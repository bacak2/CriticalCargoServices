<div style="width:800px; margin: 0 auto 0 auto; text-align: left;">
	...
	<table border="0" cellpadding="7" cellspacing="0" style="width: 100%;">
		<tr>
			...
			<td style="width: 60%; font-weight: bold; font-size: 13px; text-align: right; font-style: italic;"><br /><br /><div class='inline' style='width: 100px;'>Created:</div> <div class='data inline'><?php echo date("Y-m-d H:i:s", strtotime($Raport['raport_date'])); ?></div></td>
		</tr>
		<tr>
			<td style="width: 100%; font-size: 14px;"><br /><br /><i>Report for:</i> <span style="font-size: 16px; font-weight: 700;"><?php echo $Client; ?></span></td>
		</tr>
	</table>
	<br /><br />
