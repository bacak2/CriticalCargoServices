<?php
    $Idx = $_POST['next'];
    $PoleName = (isset($_POST['name']) ? $_POST['name'] : "Sea");
    $FCL = array();
 ...
 ?>
    <tr id="<?php echo "fcl-row-$Idx"; ?>">
        <td style="border-bottom: 1px solid #888;"><?php
            $Form->PoleSelect("{$PoleName}[FCL][$Idx][cont_dim_size]", $Size, $FCL['cont_dim_size'], "style='margin-bottom: 10px;'");
            echo "<br />";
            $Form->PoleSelect("{$PoleName}[FCL][$Idx][cont_dim_type]", $Types, $FCL['cont_dim_type']);
            ?>
        </td>
        <td style="border-bottom: 1px solid #888; background-color: #F0F0F0;"><?php $Form->PoleInputText("{$PoleName}[FCL][$Idx][cont_no]", $FCL['cont_no']); ?></td>
        ...
        <td style="border-bottom: 1px solid #888; background-color: #F0F0F0;"><?php $Form->PoleInputText("{$PoleName}[FCL][$Idx][cont_seal]", $FCL['cont_seal']); ?></td>
